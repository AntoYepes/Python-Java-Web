...
def cal_distance(coordenada, matriz):
    coord = coordenada # TOMA EL VALOR DE LA COORDENADA QUE EL USUARIO SELECCIONE
    # punto 1 coord
    ...
    if users_1 < users_2:
        ...
        flag = [1, 0] 
    print(f'La zona wifi 1: ubicada en {coord} a {need_indx[flag[0]]} metros tiene en promedio {users_1}')
    print(f'La zona wifi 2: ubicada en {coord} a {need_indx[flag[1]]} metros tiene en promedio {users_2}')
    ...
    vel_pie = 0.483
    vel_bici = 3.33
    tiempo_pie = print('Tiempo a pie: ', need_indx[flag[0]]/vel_pie)
    tiempo_bici = print('Tiempo en bici: ', need_indx[flag[0]]/vel_bici)
...
#while True:
            ...
            #if opcion == 1:
            #    cal_distance(coord_trabajo, matrix)
