                    ...
                    for n in menu_fix:
                        ...
                        # Opcion No2
                            ...
                            if result == 1:
                                ...
                                compare_list = [round(promd_lat, 3), round(promd_long, 3)]
                        ...
                        # Opcion No4
                        elif variable.strip() == 'Guardar archivo con ubicación cercana' and indice == str(opc):
                            if datos == []:
                                ...
                                if opcion == 1:
                                    ...
                                    informacion = {'actual' : datos[0],'zonawifi1' : x}
                                    print(informacion)
                        # Opcion No7                                         
