...
//        this.empleados = new ArrayList<>();
    ...
    public static double totalPagosOtorgadosAlEmpleado(Empleado empleado, int diasTrabajados){
        double liq_nom, liq_pres;
        liq_pres = Aseguradora.liquidarPrestaciones(empleado, diasTrabajados);
        liq_nom = Aseguradora.liquidarNomina(empleado, diasTrabajados);
        return liq_pres + liq_nom;
    }
}
